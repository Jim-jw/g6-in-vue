...
G6.registerNode('node', {
    drawShape: function drawShape(cfg, group) {
      ...
      const point1 = group.addShape('circle', { // eslint-disable-line no-unused-vars
        attrs: {
          x: -width / 2,
          y: 0,
          r: 3,
      ...
      const point2 = group.addShape('circle', { // eslint-disable-line no-unused-vars
        attrs: {
          x: width / 2,
          y: 0,
          r: 3,
    ...
    update: function (cfg, item) {
      ...
      const {style: {stroke}, labelStyle} = cfg  // eslint-disable-line no-unused-vars
...
G6.registerEdge('polyline', {
  ...
  draw: function draw(cfg, group) {
    ...
    // type
    const type = group.addShape('text', {  // eslint-disable-line no-unused-vars
      attrs: {
        text: cfg.data.type,
        x: line2StartPoint.x + labelLeftOffset,
    ...
    // date
    const date = group.addShape('text', { // eslint-disable-line no-unused-vars
      attrs: {
        text: cfg.data.date,
        x: line2StartPoint.x + labelLeftOffset,
